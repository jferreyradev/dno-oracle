-- Script para crear tabla de logs y datos de ejemplo
...
CREATE TABLE system_logs (
    ...
    created_date DATE GENERATED ALWAYS AS (TRUNC(created_at)) VIRTUAL,
...
-- Crear tabla de usuarios para referenciar en los logs
CREATE TABLE users (
